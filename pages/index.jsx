  ...
  return (
      ...
      <section className="hero diagonal">
        ...
        <div className="container halves">
          <div>
            <h3>{page.data.portfolio_heading}</h3>
            <p dangerouslySetInnerHTML={{
                  __html: `${page.data.portfolio_description_html}`,
                }} />
            <p><a href={`${data.site.baseurl}/portfolio`}>{page.data.portfolio_call_to_action} &rarr;</a></p>
          </div>
          <div>
